...
data = pd.read_csv('온라인뉴스_train.csv', usecols=[
    'BusinessNum', 'PressName', 'NewsDate', 'NewsTitle', 'NewsContent', 'JstName', 'UrlLink'
])
...
data.to_csv('온라인뉴스_train_처리완료.csv', index=False)
