...
data = pd.read_csv('실용신안정보_train.csv', usecols=[
    'BusinessNum', 'applicantName', 'applicationDate', 'applicationNumber',
    'inventionTitle', 'ipcNumber', 'registerNumber', 'registerStatus'
])
...
data.to_csv('실용신안정보_train_처리완료.csv', index=False)
